...
function scene:create()
	...
	objectList = 
	{
		...
		[3] = {"item",  "decor",    40, 3, 1, false, false}, -- wall candles
		[4] = {"item",  "decor",    40, 4, 1, false, false}, -- wall candles
		[5] = {"item",  "decor",    40, 5, 1, false, false}, -- wall candles
		[6] = {"item",  "decor",    40, 9, 1, false, false}, -- wall candles
		[7] = {"item", "decor",     40, 10, 1, false, false}, -- wall candles
		[8] = {"item", "decor",     40, 11, 1, false, false}, -- wall candles
		[9] = {"item", "decor",     16, 3, 3, false, false},  -- white skull
		[10] = {"item", "decor",    17, 3, 6, false, false},  -- pile of white bones
		[11] = {"item", "decor",    18, 9, 2, false, false},  -- white animal skull
		[12] = {"item", "decor",    19, 10, 3, false, false},  -- white rib cage
		[13] = {"item", "decor",    16, 9, 6, false, false},  -- white skull
	}
end
